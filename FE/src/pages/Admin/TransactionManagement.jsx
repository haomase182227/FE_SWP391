...
const TransactionManagement = () => {
  return (
    <div className="bg-[#fff4f3] font-['Inter'] text-on-surface min-h-screen antialiased">
      {/* SideNavBar */}
      <aside className="fixed left-0 h-full w-64 z-50 bg-zinc-50 dark:bg-zinc-950 flex flex-col py-8 px-4 border-r border-zinc-200/20">
        <div className="mb-10 px-2">
          <h1 className="font-['Space_Grotesk'] text-2xl font-black italic text-orange-700 dark:text-orange-500 uppercase">
            Kinetic Admin
          </h1>
          <p className="font-['Inter'] uppercase tracking-widest text-[10px] text-zinc-500 mt-1">
            Precision Velocity
          </p>
        </div>
        <nav className="flex-1 space-y-1">
          <a
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-transform duration-300 hover:translate-x-1 group"
            href="#"
          >
            <span className="material-symbols-outlined text-orange-700">dashboard</span>
            <span className="font-['Inter'] uppercase tracking-widest text-[10px] font-medium">
              Dashboard
            </span>
          </a>
          <a
            ...
            href="#"
          >
            <span className="material-symbols-outlined text-orange-700">group</span>
            <span className="font-['Inter'] uppercase tracking-widest text-[10px] font-medium">
              User Management
            </span>
          </a>
          <a
            ...
            href="#"
          >
            <span className="material-symbols-outlined text-orange-700">rule</span>
            <span className="font-['Inter'] uppercase tracking-widest text-[10px] font-medium">
              Listing Moderation
            </span>
          </a>
          <a
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-orange-50 dark:bg-orange-950/30 text-orange-700 dark:text-orange-400 font-bold border-r-4 border-orange-700 transition-transform duration-300 hover:translate-x-1 group"
            href="#"
          >
            <span className="material-symbols-outlined text-orange-700">payments</span>
          ...
          <a
            ...
            href="#"
          >
            <span className="material-symbols-outlined text-orange-700">engineering</span>
            <span className="font-['Inter'] uppercase tracking-widest text-[10px] font-medium">
              Inspectors
            </span>
          </a>
          <a
            ...
            href="#"
          >
            <span className="material-symbols-outlined text-orange-700">analytics</span>
            <span className="font-['Inter'] uppercase tracking-widest text-[10px] font-medium">
              Reports
            </span>
          </a>
        ...
        <div className="mt-auto space-y-4">
          <button className="w-full bg-primary text-on-primary py-3 px-4 rounded-lg font-['Inter'] font-bold uppercase tracking-widest text-[10px] shadow-lg shadow-primary/20 hover:opacity-90 transition-all">
            Export Global Data
          </button>
          <div className="pt-4 border-t border-zinc-200/20 space-y-1">
            <a
              className="flex items-center gap-3 px-3 py-2 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 transition-all"
              href="#"
            >
      ...
      {/* TopNavBar */}
      <header className="fixed top-0 w-full z-40 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl shadow-[0_20px_40px_rgba(78,33,32,0.06)] flex justify-between items-center px-8 h-16 pl-[18rem]">
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-4">
            <button className="text-zinc-500 hover:text-orange-600 transition-colors active:scale-95 duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <img
              ...
              data-alt="professional portrait of a man in his 30s with a sharp haircut and clean-shaven face against a minimalist gray studio background"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuCM62OSJxq8wNEnlHb8-_JeVrBeteaJL-aBPitVYe_cRkrQoJtrqeq--z9M84SWRxzjdY5W6f2GB74pV7YJnfQPeAIgdeLXKtLl8GlRfxOf4WM6Xb3IvRIkAKqU7VENZds3rU-gGmx_JhpCIzyi3-2mU-sDovIF73hOEyJd-l7NXKTWV-n5XZ0CJ0Fq3DusA5FH86IhBDYuq6DBdnoL-MQVRPICY-mIkfnxBoErJdFBWi7C2OEfLhzoFxtZjHj9_0Yh_83QUPbTTLNh"
            />
          </div>
        </div>
      </header>
