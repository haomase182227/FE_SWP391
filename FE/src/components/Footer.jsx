...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-gradient-to-br from-orange-50 via-orange-100 to-orange-50 border-t-4 border-orange-500">
      {/* Main Footer Content */}
      <div className="max-w-screen-2xl mx-auto pt-20 pb-10 px-8 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Logo/Brand Name */}
            <div>
              <h2 className="text-orange-600 text-3xl font-extrabold tracking-tighter mb-3 font-headline">
                The Kinetic
              </h2>
              <p className="text-gray-700 leading-relaxed text-sm max-w-md">
            ...
            <div className="space-y-3">
              <h3 className="text-orange-900 font-bold text-sm uppercase tracking-widest">
                Đăng ký nhận tin
              </h3>
              ...
              <form onSubmit={handleNewsletterSubmit} className="flex">
                <input
                  ...
                  required
                  className="flex-1 bg-white border-2 border-orange-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 rounded-l-lg py-3 px-4 text-sm text-gray-900 placeholder-gray-400 outline-none transition-all"
                />
                <button
                  type="submit"
                  className="bg-orange-500 hover:bg-orange-600 text-white px-6 rounded-r-lg transition-all font-semibold text-sm active:scale-95 whitespace-nowrap shadow-lg"
                >
                  Đăng ký
                </button>
              </form>
              ...
              {/* Success Message */}
              {subscribed && (
                <div className="flex items-center gap-2 text-emerald-600 text-xs font-medium animate-fade-in">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white border-2 border-orange-200 hover:bg-orange-500 hover:border-orange-500 flex items-center justify-center transition-all duration-300 group shadow-sm"
                aria-label="Facebook"
              >
          ...
          {/* ═══════════════════════════════════════════════════════════════
              ...
              ═══════════════════════════════════════════════════════════════ */}
          <div>
            <h3 className="text-orange-900 font-bold text-lg mb-6 uppercase tracking-wider">
              Sản phẩm
            </h3>
            <ul className="space-y-4">
              <li>
                <Link
                  ...
                  className="text-gray-700 hover:text-orange-600 transition-colors text-sm inline-flex items-center gap-2 group font-medium"
                >
                  <span className="w-1 h-1 bg-orange-400 rounded-full group-hover:bg-orange-600 transition-colors"></span>
                  Xe đạp đua (Road)
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  ...
                  className="text-gray-700 hover:text-orange-600 transition-colors text-sm inline-flex items-center gap-2 group font-medium"
                >
                  <span className="material-symbols-outlined text-[16px] text-orange-500 group-hover:text-orange-600 transition-colors">
                    engineering
                  </span>
                  Tech Specs Library
                </Link>
              ...
              <li>
                <Link
                  ...
                  className="text-gray-700 hover:text-orange-600 transition-colors text-sm inline-flex items-center gap-2 group font-medium"
                >
                  <span className="material-symbols-outlined text-[16px] text-orange-500 group-hover:text-orange-600 transition-colors" style={{ fontVariationSettings: '"FILL" 1' }}>
                    workspace_premium
                  </span>
        ...
        {/* ═══════════════════════════════════════════════════════════════
            ...
            ═══════════════════════════════════════════════════════════════ */}
        <div className="border-t-2 border-orange-300 mt-16 pt-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  {/* Visa */}
                  <div className="w-10 h-7 bg-white rounded border-2 border-orange-200 flex items-center justify-center shadow-sm">
              ...
              {/* Trust Badge */}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white rounded-lg border-2 border-orange-200 shadow-sm">
